  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] mt-6">
        ...
        <p className="para-base para-muted mt-1 text-[#fff]">{description}</p>
...
const ProveSection = () => {
  ...
  useGSAP(
    (context) => {
      ...
      const header = sectionRef.current?.querySelector(".gsap-prove-header");

      const cards = gsap.utils.toArray(".gsap-stat-card", sectionRef.current);
      ...
      /*
       * Pointer interactions are intentionally kept outside the
       * useGSAP context.
       *
       * This prevents React/GSAP context revert from trying to
       * reset interactive rotateX/rotateY tweens.
       */
      ...
      context.ignore(() => {
        cards.forEach((card) => {
          ...
          pointerCleanups.push(() => {
            ...
            /*
             * Kill only the interactive tweens for this card.
             * Do not create new rotateX/rotateY tweens during cleanup.
             */
