...
const PageHero = ({
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(
        [breadcrumbRef.current, headingRef.current, descRef.current, buttonRef.current, waterfallRef.current],
        ...
        onComplete: () => {
          gsap.set(
            [breadcrumbRef.current, headingRef.current, descRef.current,
             buttonRef.current, waterfallRef.current],
      ...
      tl.fromTo(waterfallRef.current,
        { opacity: 0, x: 70, y: 20 },
  ...
  return (
    <section ref={sectionRef} className="relative py-12 sm:py-14 lg:py-15 overflow-hidden">
      ...
      <Container>
        ...
        {/* breadcrumb */}
        <div ref={breadcrumbRef} className="relative z-20 mb-8 sm:mb-10 lg:mb-12">
          <BreadCrumb />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative z-20 gap-8 lg:gap-0">
          ...
          <div className="lg:col-span-2 space-y-5 sm:space-y-6">
            ...
            <p ref={descRef} className="para-base sm:para-lg text-white/80 max-w-xl">
              {heroDescription}
            </p>
          ...
          <div ref={waterfallRef} className="hidden sm:flex lg:block justify-center">
            <WaterfallStack
        ...
        {/* stats */}
        <div ref={statsRef} className="relative z-20 mt-8 sm:mt-10 lg:mt-[20px]">
